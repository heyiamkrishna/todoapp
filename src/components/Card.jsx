...
function Card(props) {
  ...
  return (
    <motion.div  drag dragConstraints={props.refc} whileDrag={{scale:1.1}}  className=" card relative grid-col-3 bg-zinc-900/20 h-[40vh] w-[55vw] sm:h-[40vh] sm:w-[40vw] md:h-[40vh] md:w-[30vw] lg:h-[40vh] lg:w-[14vw]  rounded-[40px] text-white overflow-hidden ">
