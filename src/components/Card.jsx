...
function Card(props) {
  ...
  return (
    <motion.div drag dragConstraints={props.refc} className="relative bg-zinc-900/20 h-full w-full sm:h-[40vh] sm:w-[50vw] md:h-[40vh] md:w-[30vw] lg:h-[40vh] lg:w-[14vw]  rounded-[40px] text-white overflow-hidden ">
